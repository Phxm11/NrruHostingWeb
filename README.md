...
ระบบยื่นคำขอใช้บริการ **Hosting / Virtual Server** ของมหาวิทยาลัย (NRRU) พัฒนาด้วย [Laravel](https://laravel.com) — ผู้ใช้งาน (บุคลากร) กรอกแบบฟอร์มขอใช้บริการผ่านหน้าเว็บสาธารณะ ส่วนเจ้าหน้าที่ (แอดมิน) เข้าสู่ระบบเพื่อตรวจสอบคำขอ อนุมัติ และสร้างบัญชีให้ผู้ขอใช้บริการ
