        ...
        <div class="nav-desktop">
            <div class="nav-links-group">
                <a href="{{ request()->routeIs('home') ? '' : route('home') }}#top" class="nav-link-custom" @if(request()->routeIs('home')) aria-current="location" @endif><svg class="ui-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="m3 10 9-7 9 7M5 9v12h5v-7h4v7h5V9"/></svg><span>หน้าหลัก</span></a>
                    ...
                    <a href="{{ route('domains.index') }}" class="nav-link-custom nav-link-domain" @if(request()->routeIs('domains.index')) aria-current="page" @endif><svg class="ui-icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><circle cx="10" cy="10" r="7"/><path d="m15 15 6 6M3 10h14M10 3c3 3 3 11 0 14M10 3c-3 3-3 11 0 14"/></svg><span>ตรวจสอบโดเมน</span></a>
            </div>
